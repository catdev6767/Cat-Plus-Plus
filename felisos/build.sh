...
echo "Compile:"
for f in entry.s irq.s idt.c keyboard.c string.c fs.c commands.c shell.c utils.c main.c catpp_mini.c fb.c mouse.c tty.c; do
    base="${f%.*}"
    out=$(echo "$base" | tr '/' '_')
...
ld -m elf_i386 -T kernel/linker.ld -nostdlib \
   ...
   kernel/utils.o kernel/main.o kernel/catpp_mini.o kernel/fb.o kernel/mouse.o kernel/tty.o \
   $GCC_LIB \
   -o kernel/kitty.elf
