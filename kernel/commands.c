...
static void cmd_help(void) {
    catpp_print_str("FelisOS v0.2 - Help");
    catpp_print_str("");
    catpp_print_str("--- FelisOS - He thong ---");
    ...
    catpp_print_str("  belly             Thong tin RAM (meo)");
    catpp_print_str("  tag               Thong tin phien (meo)");
    catpp_print_str("  den               Ten may (meo)");
    catpp_print_str("  locate            Tim lenh (meo)");
    catpp_print_str("  prowl             Xem process (meo)");
    catpp_print_str("  history           Xem lich su lenh");
    catpp_print_str("");
    catpp_print_str("--- Tap tin ---");
    catpp_print_str("  ls                Liet ke file");
    catpp_print_str("  cd DIR            Doi thu muc");
    catpp_print_str("  pwd               In thu muc hien tai");
    catpp_print_str("  cat               Doc file");
    catpp_print_str("  touch             Tao file rong");
    catpp_print_str("  mkdir             Tao thu muc");
    catpp_print_str("  rm                Xoa file");
    catpp_print_str("  rmdir             Xoa thu muc");
    catpp_print_str("  cp SRC DST        Copy file");
    catpp_print_str("  mv SRC DST        Move/rename");
    catpp_print_str("  stat              Info file");
    catpp_print_str("  find              List de quy");
    catpp_print_str("  du                Tong dung luong");
    catpp_print_str("  write             Ghi vao file");
    catpp_print_str("  append            Them vao file");
    catpp_print_str("");
    catpp_print_str("--- Van ban (meo) ---");
    catpp_print_str("  wc FILE           Dem tu/ky tu");
    catpp_print_str("  order             Sap xep dong (meo)");
    catpp_print_str("  unique            Loai dong trung (meo)");
    catpp_print_str("  carve -d X -f N   Cat truong (meo)");
    catpp_print_str("  swap OLD NEW      Doi ky tu (meo)");
    catpp_print_str("  count N           In 1..N (meo)");
    catpp_print_str("  chirp [TEXT]      In lap (meo)");
    ...
    catpp_print_str("");
    catpp_print_str("--- Bien moi truong ---");
    ...
    catpp_print_str("  mew <cmd>         Chay voi quyen cao");
    catpp_print_str("");
    catpp_print_str("--- Khac ---");
    catpp_print_str("  echo TEXT         In TEXT");
    catpp_print_str("  sleep N           Doi N giay");
    catpp_print_str("  reboot            Khoi dong lai");
    catpp_print_str("  halt              Dung CPU");
    catpp_print_str("  exit              Thoat shell");
    catpp_print_str("  scratch           Ve meo ASCII (easter)");
    catpp_print_str("  purr              Easter egg");
    catpp_print_str("");
}
